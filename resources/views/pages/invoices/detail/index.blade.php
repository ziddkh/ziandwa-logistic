                                            ...
                                            <div class="inv--head-section inv--detail-section">
                                                <div class="row">
                                                    <div class="col-sm-6 col-12 mr-auto">
                                                        ...
                                                        <p class="inv-email-address fw-normal">Jl. Kebon Kacang 4, Nomor 39, Kelurahan Tanah Abang, Kecamatan Tanah Abang, Kota Jakarta Pusat.</p>
                                                    </div>
                                            ...
                                            <div class="inv--detail-section inv--customer-detail-section">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-8 col-lg-7 col-md-6 col-sm-4">
                                                        <p class="inv-customer-name">{{ $invoiceHeader->paymentDetail->paymentHeader->shipmentHeader->recipient_name }}</p>
                                                        <p class="inv-street-addr">{{ $invoiceHeader->paymentDetail->paymentHeader->shipmentHeader->recipient_address }}</p>
                                                        <p class="inv-email-address">{{ $invoiceHeader->paymentDetail->paymentHeader->shipmentHeader->recipient_phone }}</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="inv--product-table-section">
                                                <div class="table-responsive mb-3">
                                                    <table class="table">
                                                        <thead class="">
                                                            <tr>
                                                                <th scope="col" class="text-start" style="width: 200px; min-width: 200px;">Nama Kapal</th>
                                                                ...
                                                                <th scope="col" class="text-center" style="width: 220px; min-width: 220px;">Total</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            @php
                                                            ...
                                                            @foreach ($invoiceHeader->invoiceItems as $item)
                                                                @if ($item->type === 'bale')
                                                                    ...
                                                                    @endphp
                                                                    <tr>
                                                                        <td class="text-start" style="width: 200px; min-width: 200px;">{{ $item->ship_name }}</td>
                                                                        ...
                                                                        <td class="text-center" style="width: 220px; min-width: 220px;">Rp. {{ number_format($item->price, 0, ',', '.') }}</td>
                                                                    </tr>
                                                                @endif
                                                            @endforeach
                                                        </tbody>
                                                    ...
                                                    <div class="col-sm-7 col-12 order-sm-1 order-0">
                                                        <div class="text-sm-end">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-4 col-5">
                                                                    <p class="">Rp. {{ number_format($invoiceHeader->paymentDetail->paymentHeader->shipmentHeader->destination_cost, 0, ',', '.') }}</p>
                                                                </div>
                                                                <div class="col-sm-8 col-7">
                                                                    <p class=" discount-rate">Subtotal :</p>
                                                                </div>
                                                                <div class="col-sm-4 col-5">
                                                                    <p class="">Rp. {{ number_format($invoiceHeader->total_amount, 0, ',', '.') }}</p>
                                                                </div>
                                                                <div class="col-sm-8 col-7">
                                                                    <p class=" discount-rate">Diskon :</p>
                                                                </div>
                                                                <div class="col-sm-4 col-5">
                                                                    <p class="">Rp. {{ number_format($invoiceHeader->paymentDetail->paymentHeader->discount, 0, ',', '.') }}</p>
                                                                </div>
                                                                <div class="col-sm-8 col-7">
                                                                ...
                                                                <div class="col-sm-4 col-5 grand-total-amount mt-3">
                                                                    <h4 class="text-dark">Rp. {{ number_format($invoiceHeader->total_amount, 0, ',', '.') }}</h4>
                                                                </div>
                                                                @if ($invoiceHeader->paymentDetail->paymentHeader->payment_method === 'DP')
                                                                    ...
                                                                    <div class="col-sm-4 col-5 grand-total-amount mt-3">
                                                                        <h4 class="text-dark">Rp.{{ number_format($invoiceHeader->paymentDetail->paymentHeader->grand_total_payment-$invoiceHeader->total_amount, 0, ',', '.') }}</h4>
                                                                    </div>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="d-flex justify-content-center">
                                                            <div class="d-flex flex-column">
                                                                ...
                                                                <p class="text-center mt-5">Tiga Sembilan Logistic</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
