        ...
        <div class="sidebar-wrapper sidebar-theme">
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    @if (auth()->user()->can('view-shipper') || auth()->user()->can('create-shipper'))
                        <li class="menu {{ Request::is('dashboard/shipper/*') ? "active" : "" }}">
                            <a href="#shipper" data-bs-toggle="collapse" aria-expanded="{{ Request::is('dashboard/shipper/*') ? "true" : "false" }}" class="dropdown-toggle">
                                <div class="">
                            ...
                            <ul class="collapse submenu list-unstyled {{ Request::is('dashboard/shipper/*') ? "show" : "" }}" id="shipper" data-bs-parent="#accordionExample">
                                @if (auth()->user()->can('create-shipper'))
                                    <li class="{{ Request::routeIs('shipper.create') ? 'active' : '' }}">
                                        <a href="{{ route('shipper.create') }}/"> Tambah </a>
                                    </li>
                                @endif
                                @if (auth()->user()->can('view-shipper'))
                                    <li class="{{ Request::routeIs('shipper.index') ? 'active' : '' }}">
                                        <a href="{{ route('shipper.index') }}/"> List </a>
                                    </li>
                                @endif
                            </ul>
                        </li>
